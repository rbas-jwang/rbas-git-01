...
const db_total = 9;
const min_vote = 5;
const rs_db_port = 1910 + rs_id;

const version = "RBAS V0.9.2022/08/19 ";
const fs = require("fs");

let init_json = { "tick": 1000000000, "chain": "38b6aba0e9981a60", "next_chain": "38b6aba0e9981a60" }
let wait = 0;
let tick = 1000000000;
let time = "";
...
function term_disp() {
  ...
  console.log("\033[1;32m       db_tick = \033[1;37m" + db_tick);
